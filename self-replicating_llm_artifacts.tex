...
This paper documents an empirically observed failure mode in large language models from four major vendors—Anthropic, Google, Perplexity, and DeepSeek—discovered not through deliberate red-teaming but through ordinary developer workflow. The artifact that induced these failures was not constructed to break anything. It emerged from a bootstrap installer project, built by one person with no institutional affiliation, no research budget, and no stable housing, while using commercial LLMs as a productivity tool to transform informal technical notes into beginner-readable documentation.
I am not a credentialed academic. I have no mentor, no lab, no salary contingent on these findings being convenient for anyone. What I have is a decade of cybersecurity experience, a formal research program connecting computational complexity, thermodynamics, and information theory, and a set of timestamped publications that document what I understood and when. I also have the kind of skin in the game that institutional researchers are structurally prevented from having: my own published arguments constrain what I can claim here more tightly than any peer reviewer could. If my logic fails, I bear that cost alone and completely. I have no institution to diffuse the risk into, no more receptive future audience to defer to, and no NDA protecting me from the consequences of being wrong in public.
In 2011, while working in a strip club and managing a drug addiction, I argued that DNA was too informationally dense and informationally complex to permit easy genetic engineering — before I had the mathematics to formalize it. Physicists would later develop related ideas under the name assembly theory. I do not cite this as credential. I cite it as pattern: independent derivation, before the formal apparatus, from someone with no reason to arrive at the right answer except that the evidence pointed there.
This paper is a similar document. It represents my understanding of this failure class at time of first publication, refined over the two months since by formal study of how large language models are actually trained — not from institutional access, but by navigating a signal-to-noise problem where the primary sources are either boosters, critics, or the very systems under examination. That this refinement was possible under those conditions is itself evidence of the finding's robustness. The failure state I documented is real, it is structural, and it is already in the weights of every model that inherited it through incremental training on top of compromised predecessors.
I did not introduce this failure. I found it. The distinction matters.
This paper documents what I saw when I got off the boat.
